...
public class OllamaIA implements IAInterface {
    
    private final OllamaClient client;
    private final String modelName;
    
    public OllamaIA(String modelName) {
        this.client = new OllamaClient();
        this.modelName = modelName;
    }
    
    public OllamaIA(String modelName, String baseUrl) {
    ...
    public EisenhowerTag analyzeEmail(String emailText) throws Exception {
        ...
        String prompt = createPrompt(cleanedText);
        
        String response = client.generateResponse(modelName, prompt);
        System.out.println("Réponse " + modelName + ": " + response);
    ...
    private String createPrompt(String emailText) {
